...
export default class Shop extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            actresses: [
                { imgactress: 'images/1/qq.jpg' },
                { imgactress: 'images/1/g.jpg' },
                { imgactress: 'images/1/u.jpg' },

            ],
            products: [

                { actress: 'j', id: 5, desc: '7/5 از 10', price: "90", img: 'images/1/x.jpg', title: 'آرامش در شمال' },

                { actress: 'j', id: 8, desc: '7/5 از 10', price: "120", img: 'images/1/qq.jpg', title: 'یک تکه شیکاگویی ' },

                { actress: 'j', id: 6, desc: '7/5 از 10', price: " 50", img: 'images/1/tt.jpg', title: 'ببر 3' },
                { actress: 'c', id: 9, desc: '7/5 از 10', price: " 120", img: 'images/1/pp.jpg', title: 'عشق در زمین گلف' },
                ...
                { actress: 'j', id: 10, desc: '7/5 از 10', price: "120", img: 'images/1/zz.jpg', title: 'بدون احساس ناراحتی' },
                { actress: 'c', id: 11, desc: '6/5 از 10', price: "300", img: 'images/1/ww.webp', title: 'اسید' },
                { actress: 'e', id: 12, desc: '6/5 از 10', price: "60", img: 'images/1/kk.jpg', title: 'بدشانسی بتی در عشق' },
                ...
                { actress: 'j', id: 16, desc: '7/5 از 10', price: "120", img: 'images/1/1.jpg', title: 'بدون احساس ناراحتی' },
                { actress: 'c', id: 17, desc: '6/5 از 10', price: "300", img: 'images/1/4.jpg', title: 'اسید' },
                ...
                <div className='shop-body'>
                    ...
                    <div className='valed-parent-actressimage'  >
                        ...
                        <div className='parent-actressimage'>
                            ...
                            <button className={this.state.one ? 'btn-actressone' : 'btn-actressone opa'} type="button" onClick={this.onFiltere.bind(this)}>

                            </button>
                            <img className={this.state.one ? 'actressimage' : '  actressimage opai'} src={this.state.actresses[2].imgactress} />
                        </div>

                        <div className='parent-actressimage' >

                            <button className={this.state.three ? 'btn-actressthree' : 'btn-actressthree opa'} type="button" onClick={this.onFilterj.bind(this)}>


                            </button>
                            <img className={this.state.three ? 'actressimage' : '  actressimage opai'} src={this.state.actresses[0].imgactress} />

                        </div>

                        <div className='parent-actressimage'>

                            <button className={this.state.tow ? 'btn-actresstow' : 'btn-actresstow opa'} type="button" onClick={this.onFilterc.bind(this)}>

                            </button> <img className={this.state.tow ? 'actressimage' : 'actressimage opai'} src={this.state.actresses[1].imgactress} />
                        </div>
                    </div>
